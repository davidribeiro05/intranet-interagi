...
Also, add a `prod.yml` file to `inventory` folder (with information about the production server), and a `davidribeiro05-prod.yml` to `host_vars` folder.
